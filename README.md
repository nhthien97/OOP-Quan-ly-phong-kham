...
Mỗi entity đều được xây dựng đầy đủ các chức năng Create - Read - Update - Delete thông qua:
...
-Sử dụng JUnit 5
-Test đơn vị (unit test) cho lớp AdmissionService
## Bắt & xử lý lỗi
-Sử dụng @ControllerAdvice và @ExceptionHandler để xử lý lỗi toàn cục.
-Lỗi được bắt và hiển thị thông qua giao diện tùy chỉnh (templates/error/general.html).
